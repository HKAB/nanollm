...
import psutil
import torch
from nanollm.common import get_base_dir, get_dist_info
...
def get_system_info():
    ...
    info['nanollm_cache_dir'] = os.environ.get('NANOLLM_CACHE_DIR', 'out')
...
# -----------------------------------------------------------------------------
# nanollm-specific convenience functions
